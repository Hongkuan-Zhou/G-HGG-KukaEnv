...
MODEL_XML_PATH = 'R800_full_push_labyrinth_gravity.xml'



class PushLabyrinthEnv(push_env.PushEnv, gym_utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        self.adapt_dict["field"] = [0.75, 0, 1.05, 0.25, 0.35, 0.05]
        self.adapt_dict["obstacles"] = [[0.65, 0, 1.1, 0.11, 0.02, 0.1], [0.52, 0, 1.1, 0.02, 0.35, 0.1], [0.78, 0, 1.1, 0.02, 0.2, 0.1]]

        push_env.PushEnv.__init__(
            self, MODEL_XML_PATH, has_object=True, n_substeps=20,
            target_in_the_air=False, target_offset=0.0,
            obj_range=0.06, target_range=0.06, distance_threshold=0.05,
    ...
    def _env_setup(self, initial_qpos):
        ...
        rotation = self.sim.data.get_body_xquat('needle_tip').copy()
