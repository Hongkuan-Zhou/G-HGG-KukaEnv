...
MODEL_XML_PATH = 'R800_full_pick_and_place_obstacle_gravity.xml'


class PickObstacleEnv(fetch_env.FetchEnv, gym_utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        self.adapt_dict["obstacles"] = [[0.75, 0, 1.075, .25, 0.04, .075]]
